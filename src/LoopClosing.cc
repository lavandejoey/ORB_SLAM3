...
namespace ORB_SLAM3 {
    ...
    LoopClosing::LoopClosing(Atlas *pAtlas, KeyFrameDatabase *pDB, ORBVocabulary *pVoc, const bool bFixScale,
            ...
            mbFinishedGBA(true),
            mbStopGBA(false), mpThreadGBA(nullptr), mbFixScale(bFixScale), mnFullBAIdx(0), mnLoopNumCoincidences(0),
    ...
    bool LoopClosing::DetectCommonRegionsFromBoW(std::vector<KeyFrame *> &vpBowCand, KeyFrame *&pMatchedKF2,
        ...
        for (KeyFrame *pKFi: vpBowCand) {
            ...
            ::std::vector<KeyFrame *> vpKeyFrameMatchedMP = ::std::vector<KeyFrame *>(
                    mpCurrentKF->GetMapPointMatches().size(), static_cast<KeyFrame *>(nullptr));
