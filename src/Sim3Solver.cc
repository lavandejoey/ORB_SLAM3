...
namespace ORB_SLAM3 {
    ...
    /**
     * @brief Sim3Solver constructor 1/1,
     * Sim3Solver is a class that computes the Sim3 transformation between two keyframes
     * @param pKF1
     * @param pKF2
     * @param vpMatched12 vector for the matched map points between the two keyframes
     * @param bFixScale enable/disable the scale optimization
     * @param vpKeyFrameMatchedMP vector for the matched keyframes between the two keyframes
     */
