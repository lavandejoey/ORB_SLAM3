...
//For stereo fisheye matching
    ...
    Frame::Frame() : mpcpi(nullptr), mpImuPreintegrated(nullptr), mpPrevFrame(nullptr), mpImuPreintegratedFrame(nullptr),
                     mpReferenceKF(static_cast<KeyFrame *>(nullptr)), mbIsSet(false), mbImuPreintegrated(false),
...
//Copy Constructor
    ...
    Frame::Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timeStamp, ORBextractor *extractorLeft,
            ...
            : mpcpi(nullptr), mpORBvocabulary(voc), mpORBextractorLeft(extractorLeft), mpORBextractorRight(extractorRight),
              mTimeStamp(timeStamp), mK(K.clone()), mK_(Converter::toMatrix3f(K)), mDistCoef(distCoef.clone()), mbf(bf),
              mThDepth(thDepth),
              mImuCalib(ImuCalib), mpImuPreintegrated(nullptr), mpPrevFrame(pPrevF), mpImuPreintegratedFrame(nullptr),
              mpReferenceKF(static_cast<KeyFrame *>(nullptr)), mbIsSet(false), mbImuPreintegrated(false),
    ...
    Frame::Frame(const cv::Mat &imGray, const cv::Mat &imDepth, const double &timeStamp, ORBextractor *extractor,
            ...
            : mpcpi(nullptr), mpORBvocabulary(voc), mpORBextractorLeft(extractor),
    ...
    Frame::Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timeStamp, ORBextractor *extractorLeft,
            ...
            : mpcpi(nullptr), mpORBvocabulary(voc), mpORBextractorLeft(extractorLeft), mpORBextractorRight(extractorRight),
              ...
              mThDepth(thDepth),
              mImuCalib(ImuCalib), mpImuPreintegrated(nullptr), mpPrevFrame(pPrevF), mpImuPreintegratedFrame(nullptr),
              mpReferenceKF(static_cast<KeyFrame *>(nullptr)), mbImuPreintegrated(false), mpCamera(pCamera),
              mpCamera2(pCamera2),
              mbHasPose(false), mbHasVelocity(false) {
