...
namespace ORB_SLAM3 {
    ...
    /**
     * @brief System constructor 1/1
     * @param strVocFile The path to the vocabulary file
     * @param strSettingsFile The path to the settings file
     * @param sensor The sensor used in the input sequence(enum: MONOCULAR, STEREO, RGBD, IMU_MONOCULAR, IMU_STEREO, IMU_RGBD)
     * @param bUseViewer Whether to use the viewer or not
     * @param initFr The initial frame to start the SLAM system
     * @param strSequence The path to the sequence to be used
     */
    System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
        ...
        //Check settings file
        cv::FileStorage fsSettings(strSettingsFile, cv::FileStorage::READ); // Read the settings file
        ...
        if (!node.empty() && node.isString() && node.string() == "1.0") {
            ...
            cout << (*settings_) << endl;
        } else { // Fallback to loading individual parameters
            settings_ = nullptr;
