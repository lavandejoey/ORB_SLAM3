...
namespace ORB_SLAM3 {
    ...
    /**
     * class Atlas is a singleton class, with the functions for managing the maps
     * @param initKFid is the id of the first keyframe of the first map
     */
    Atlas::Atlas() {
