...
namespace ORB_SLAM3 {
    ...
    KeyFrame::KeyFrame() :
            ...
            mbf(0), mb(0), mThDepth(0), N(0), mvKeys(static_cast<vector<cv::KeyPoint> >(0)),
            mvKeysUn(static_cast<vector<cv::KeyPoint> >(0)),
            mvuRight(static_cast<vector<float> >(0)), mvDepth(static_cast<vector<float> >(0)), mnScaleLevels(0),
            mfScaleFactor(0),
            mfLogScaleFactor(0), mvScaleFactors(0), mvLevelSigma2(0), mvInvLevelSigma2(0), mnMinX(0), mnMinY(0),
            mnMaxX(0),
            mnMaxY(0), mPrevKF(static_cast<KeyFrame *>(nullptr)), mNextKF(static_cast<KeyFrame *>(nullptr)),
    ...
    KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB) :
            ...
            mpORBvocabulary(F.mpORBvocabulary), mbFirstConnection(true), mpParent(nullptr), mDistCoef(F.mDistCoef),
            ...
            mNameFile(F.mNameFile), mnMergeCorrectedForKF(0),
